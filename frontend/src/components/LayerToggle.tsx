...
export default function LayerToggle() {
  ...
  return (
    <div className="pointer-events-auto absolute right-3 top-3 z-30 flex w-44 flex-col rounded-lg border border-zinc-700/70 bg-zinc-900/85 shadow-lg backdrop-blur">
      <button
