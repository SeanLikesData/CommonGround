...
export default function ModeBadge() {
  ...
  return (
    <div className="pointer-events-none absolute left-3 top-3 z-30 flex items-center gap-2 rounded-lg border border-zinc-700/70 bg-zinc-900/85 px-3 py-1.5 shadow-lg backdrop-blur">
